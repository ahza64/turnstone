...
return (
  <div id="professional" className="pageGrid">
  <h2>Professional</h2>
  ...
  I come from a family of creative types and have a lot of experience in the design and production of actual products in use. A family that always has projects going. Design comes like a second language. End-to-end design speciality with a new found focus on front end.
  </div>
  {/*
    <h2>My Professionalism Page</h2>
