...
import topLion from './hookshome/topLion.png';
import botMatrix from './hookshome/botMatrix.png';
import exHooks from './hookshome/exHooks.png';
import dynamicTransitions from './hookshome/dynamicTransitions.png';
...
const ContactMePage = () => {
  return (
    <div id="projects" className="pageGrid wrapper">
      ...
      <a className="projectImages reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reactionPage} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reducerPattern} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reducerCode} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={actionCode} alt="slot2 image"/></a>
      <div className="reactionText" >
      This project is an advanced project showcasing the new hooks reducer pattern that replaces the Flux library and so much more. It focuses on understanding the state action -> reducer management design pattern and what one would typically see in larger applications. The app also covers the typical (if not all) available hooks, including building custom hooks. There is no server or database, but the app is triple binding, using pubsub, which means, any users currently using the app, will see any new activity that others will add. I honestly look forward to building my next project and working on teams with hooks.
      </div>

      <h3 className="projectTitle">2.) World of warships data visualisation</h3>
      <a className="projectImages wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={yellowGraph} alt="slot2 image"/></a>
      <a className="projectImages wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={spider} alt="slot2 image"/></a>
      <a className="projectImages wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={fullDetail} alt="slot2 image"/></a>
      <a className="projectImages wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={removedMods} alt="slot2 image"/></a>
      ...
      <h3 className="projectTitle">3.) Home App Reaction</h3>
      <a className="projectImages reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={topLion} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={botMatrix} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={exHooks} alt="slot2 image"/></a>
      <a className="projectImages reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={dynamicTransitions} alt="slot2 image"/></a>
      <div className="reactionText" >
      This application is built with custom hooks (image 3-4), and is a generic home page showing off the different hooks used in react. Two features have been disabled due to those APIs no longer being serviced. But 90% of the features and useability are still there. The top (image 1) is a search bar that will redirect you to google with those search results. There is also a task list, where you can add, edit (cross off) and delete tasks. The bottom (image 2) are images that cycle through, that can be adjusted dynamically, using custom hooks.
      </div>
