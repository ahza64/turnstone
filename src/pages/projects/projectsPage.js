...
const ContactMePage = () => {
  return (
    <div id="projects" className="pageGrid wrapper">
      ...
      <a className="reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reactionPage} alt="slot2 image"/></a>
      <a className="reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reducerPattern} alt="slot2 image"/></a>
      <a className="reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={reducerCode} alt="slot2 image"/></a>
      <a className="reactionImg" href="https://vibrant-darwin-54679b.netlify.app/"><img className="projectImages" src={actionCode} alt="slot2 image"/></a>
      ...
      <a className="wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={yellowGraph} alt="slot2 image"/></a>
      <a className="wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={spider} alt="slot2 image"/></a>
      <a className="wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={fullDetail} alt="slot2 image"/></a>
      <a className="wowsImg" href="https://wows-compare.herokuapp.com/"><img className="projectImages" src={removedMods} alt="slot2 image"/></a>
      ...
      // <a className="reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={reactionPage} alt="slot2 image"/></a>
      // <a className="reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={reducerPattern} alt="slot2 image"/></a>
      // <a className="reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={reducerCode} alt="slot2 image"/></a>
      // <a className="reactionImg" href="https://relaxed-hypatia-11c312.netlify.app/"><img className="projectImages" src={actionCode} alt="slot2 image"/></a>
      // <div className="reactionText" >
      //
      // </div>
