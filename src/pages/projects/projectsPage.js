...
const ContactMePage = () => {
  return (
    <div id="projects" className="pageGrid wrapper">
      ...
      <h3 className="projectTitle">1.) World of warships data visualisation</h3>
      <a className="p1i1 p1i" href="https://wows-compare.herokuapp.com/"><img id="slot2img" src={yellowGraph} alt="slot2 image"/></a>
      <a className="p1i2 p1i" href="https://wows-compare.herokuapp.com/"><img id="slot2img" src={spider} alt="slot2 image"/></a>
      <a className="p1i3 p1i" href="https://wows-compare.herokuapp.com/"><img id="slot2img" src={fullDetail} alt="slot2 image"/></a>
      <a className="p1i4 p1i" href="https://wows-compare.herokuapp.com/"><img id="slot2img" src={removedMods} alt="slot2 image"/></a>
      <div className="p1t1" >
