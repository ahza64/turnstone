...
} = require("@react-stately/checkbox");
...
const $d758342572ac6f9b277258e54c98$export$CheckboxGroupContext = _react.createContext(null);
...
function $c3b2eaa0f618cced51a19c0a61137bb$var$Checkbox(props, ref) {
  ...
  let {
    ...
    validationState
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["isIndeterminate", "isEmphasized", "isDisabled", "autoFocus", "children", "validationState"]);
  ...
  ? useCheckboxGroupItem(_babelRuntimeHelpersExtends({}, props, {
...
function $bf1a119e1eaf6ba1863e010f786bdc$var$CheckboxGroup(props, ref) {
  ...
  let {
    ...
    validationState
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["isEmphasized", "isRequired", "necessityIndicator", "label", "labelPosition", "labelAlign", "children", "orientation", "validationState"]);
  ...
  return /*#__PURE__*/_react.createElement("div", _babelRuntimeHelpersExtends({}, styleProps, groupProps, {
...
const CheckboxGroup = _react.forwardRef($bf1a119e1eaf6ba1863e010f786bdc$var$CheckboxGroup);
